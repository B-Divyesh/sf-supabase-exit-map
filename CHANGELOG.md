...
- Local Supabase project scanner with terminal, JSON, and Markdown reports.
- Dependency-specific portability, effort, replacement, and checklist guidance.
- Static documentation and live report explorer with optional Planning Room license unlock.
